...
if exist skipframes-v1.14.0.exe del skipframes-v1.14.0.exe
g++ skipframes.cpp ^
    -o skipframes-v1.14.0.exe ^
...
echo.
echo ==========================================
echo      BUILD SUCCESS: skipframes-v1.14.0.exe
echo ==========================================
echo.
pause